            ...
            <div class="swiper offersSwiper">
                <div class="swiper-wrapper">
                    ...
                    foreach ($products as $product) :
                        ...
                        $product_description = wp_trim_words($product->get_description(), 15);
                        $product_image_url = get_the_post_thumbnail_url($product_id, 'full') ?: get_template_directory_uri() . '/assets/images/product.jpg';
                    ?>
                        <div class="swiper-slide bg-[#FCFBF7]">
                            ...
                            <div class="infos-wrapper p-4 flex flex-col gap-y-3">
                                <span class="text-lg text-cs-primary font-bold"><?= wc_price($product_price) ?></span>
                                <h3 class="text-xl text-cs-black font-montserrat font-bold"><?= $product_name ?></h3>
                                <p class="text-cs-black/60 font-light"><?= $product_description ?></p>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="" class="bg-cs-accent text-white text-lg font-medium py-3 px-10 rounded-md">Add to Cart</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
